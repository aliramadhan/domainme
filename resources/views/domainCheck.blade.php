	  ...
	  <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
	    <header class="flex justify-between items-center border-b py-4 md:py-8 mb-8 md:mb-12 xl:mb-16">
	      ...
	      <a href="/" class="inline-flex items-center text-black-800 text-2xl md:text-3xl font-bold gap-2.5" aria-label="logo">
	        <svg width="95" height="94" viewBox="0 0 95 94" class="w-6 h-auto text-blue-500" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
	          <path d="M96 94H0V47L48 0H96Z" />
	        </svg>
	      ...
	      <nav class="hidden lg:flex gap-12">
	        <a href="#" class="text-blue-500 text-lg font-semibold">Home</a>
	        <a href="#" class="text-gray-600 hover:text-blue-500 active:text-blue-700 text-lg font-semibold transition duration-100">Features</a>
	        <a href="#" class="text-gray-600 hover:text-blue-500 active:text-blue-700 text-lg font-semibold transition duration-100">Pricing</a>
	        <a href="#" class="text-gray-600 hover:text-blue-500 active:text-blue-700 text-lg font-semibold transition duration-100">About</a>
	      </nav>
	      <!-- nav - end -->
	    </header>

	    <section class="flex flex-col items-center">
	      <div class="max-w-2xl flex flex-col items-center text-center pt-8 lg:pt-32 pb-16 lg:pb-48">
	        <p class="text-blue-500 md:text-lg xl:text-xl font-semibold mb-4 md:mb-6">Very proud to introduce</p>

	        <h1 class="text-black-800 text-4xl sm:text-5xl md:text-6xl font-bold mb-8 md:mb-12">Revolutionary way to find your domain</h1>
